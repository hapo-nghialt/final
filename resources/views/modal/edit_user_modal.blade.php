        ...
        <div class="modal-content">
            ...
            <div class="modal-body container edit-user-form row m-0">
                <div class="col-md-3 p-0 d-flex justify-content-center flex-column align-items-center">
                    ...
                    <input type="file" hidden name="avatar" id="change-user-avatar">
                    <label for="change-user-avatar" class="text-change-avatar">
                        Thay Đổi
                    </label>
                </div>
                <div class="col-md-9">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-9 form-item">
                            <input type="text" name="name" value="{{ $user->phone_number }}">
                        </div>
                    </div>
                </div>
            </div>
