            ...
            <div class="topbar-menu-area">
                <div class="container">
                    ...
                    <div class="topbar-menu right-menu">
                        <ul>
                            <li class="menu-item" ><a title="Register or Login" href={{ route('user.login') }}>Login</a></li>
                            <li class="menu-item" ><a title="Register or Login" href={{ route('user.register') }}>Register</a></li>
